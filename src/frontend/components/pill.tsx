...
export const Pill = ({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-[#262626]/50 transform-gpu font-medium text-foreground/70 backdrop-blur-xs font-mono text-sm inline-flex items-center justify-center px-5 h-10 border border-border relative',
